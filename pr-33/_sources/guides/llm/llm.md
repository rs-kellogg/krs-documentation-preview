...
Override settings such as `MODEL` by prefixing the command (for example `MODEL=gemma4:31b ...`). See [Open Source LLMs on KLC (user guide)](../../services/klc/user-guide/llm-klc.md) for the full workflow, optional environment variables, and Python client setup.
