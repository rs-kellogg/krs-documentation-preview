...
Copies of these datasets are also available on the [Kellogg Linux Cluster (KLC)](/services/klc/user-guide/klc-user-guide), accessible only to PhD students and faculty who have registered for access and whose projects have been approved by the Kilts Center.
...
A complete list of policies can be found [here](https://www.chicagobooth.edu/research/kilts/research-data/nielseniq/policies).

## Data Coverage & Key Identifiers

| Attribute | Value |
|---|---|
| **Geographic coverage** | US (all markets) |
| **Unit of observation** | Household purchase (Consumer Panel); Store-week-product (Retail Scanner); Ad occurrence (Ad Intel) |
| **Key variables** | Purchase quantities, prices, store/outlet identifiers, household demographics, advertising spend by media type and DMA |

## Related Datasets

- [Compustat North America](compustat-north-america) — firm-level financial data that may be linked to brand/company identifiers
