...
A limited amount of Web of Science raw data can be made available to a limited number of academic researchers through the [Kellogg Data Hosting — Athena platform](/services/kellogg-data-hosting/athena/athena), as well as the KLC at `/kellogg/data/WOS`. To inquire about this resource, contact [Research Support](mailto:rs@kellogg.northwestern.edu).
