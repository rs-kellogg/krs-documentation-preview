...
(kellogg-datasets)=
# Kellogg Dataset Catalog

Full catalog of Kellogg Research Support licensed datasets. Individual dataset pages are linked from the platform sections ([WRDS](/services/kellogg-data-hosting/wrds/wrds), [Athena](/services/kellogg-data-hosting/athena/athena), [Redivis](/services/kellogg-data-hosting/redivis/redivis), [KLC](/services/klc/klc-datasets)) or via {doc}`Find Data by Platform <by-platform>`.
...
MSCI (formerly KLD and GMI Ratings) <datasets/msci--formerly-klc-and-gmi-ratings->
