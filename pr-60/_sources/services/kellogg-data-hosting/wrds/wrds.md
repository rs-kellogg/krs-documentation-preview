...
WRDS is one of the platforms under [Kellogg Data Hosting](../kdc). Unlike Athena, Redivis, and on-cluster file datasets, WRDS is operated by the Wharton School and accessed through their infrastructure directly.
...
Use the WRDS web interface to browse datasets and run small interactive queries. For programmatic analysis, connect from the Kellogg Linux Cluster (KLC):
