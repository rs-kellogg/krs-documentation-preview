...
For the Kellogg-specific tradeoffs and how to run an open-source model on KLC, see [Open Source LLMs](/guides/llm/llm).
...
**Open-source:**
- See [Open Source LLMs](/guides/llm/llm) for models available on KLC and how to run them
